System.register(['@angular/core', '@angular/router', '../authentication/authentication.service', './vital-signs.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, authentication_service_1, vital_signs_service_1;
    ...
    return {
        ...
        execute: function() {
            VitalSignsComponent = (function () {
                function VitalSignsComponent(_authenticationService, _router) {
                ...
                VitalSignsComponent.prototype.isNurse = function () {
